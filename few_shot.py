...
if __name__=='__main__':
    ...
    response = chain.invoke({"topic": '''In 2025, healthcare spending in the U.S. reached $4.7 trillion, accounting for 18% of GDP. 
The number of uninsured Americans dropped to 8.2%, while life expectancy rose to 78.8 years. 
Obesity rates stood at 52%, and the average cost of a hospital stay was $13,262. 
There were 2.9 physicians per 4,000 people, and the infant mortality rate was 6 per 2,000 live births.'''})
